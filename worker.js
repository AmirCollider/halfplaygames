...
async function handleRequest(request) {
    // آدرس‌های تصاویر از GitHub (با استفاده از محتوای خام)
    const logoURL = 'https://raw.githubusercontent.com/halfplaygames/Images/main/Logo.png';
    const promoURL = 'https://raw.githubusercontent.com/halfplaygames/Images/main/promo.png';
    const flagEN = 'https://raw.githubusercontent.com/halfplaygames/Images/main/FE.png';
    const flagFA = 'https://raw.githubusercontent.com/halfplaygames/Images/main/FI.png';
    const flagJA = 'https://raw.githubusercontent.com/halfplaygames/Images/main/FJ.png';
    ...
    <section class="donation-section unified-animated-background" id="donation">
        <div class="donation-container">
            ...
            <div class="donation-card animate-on-scroll">
                ...
                <a href="https://reymit.ir/amircollider" target="_blank" class="donation-link" data-i18n="donation.button">
                    Donate Now via Reymit 💖
                </a>
            </div>
            ...
            <div class="payment-info animate-on-scroll" style="transition-delay: 100ms;">
                ...
                <div class="payment-methods">
                    ...
                    <div class="payment-method">
                        ...
                        <a href="https://reymit.ir/amircollider" target="_blank" class="payment-link">
                            reymit.ir/amircollider →
                        </a>
                    </div>
                    <div class="payment-method">
                        <h4 data-i18n="contact.cryptoPayment">₿ Cryptocurrency (USDT BEP20 BSC)</h4>
                        <div class="crypto-address">
                            0x086ed7bcbe68f56ee53e7d47bb41a6ff9bfbb6d8
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        const translations = {
            en: {
                ...
                donation: { title: "Support Our Charity Mission", cardTitle: "💝 Donate to HalfPlay Games", text: "Your direct donations amplify our ability to expand our charity work and build a better world through the power of gaming. A full 50% of every donation goes directly to our charity initiatives!", button: "Donate Now via Reymit 💖", info1: "<strong>How your donation helps:</strong> Half of your donation amount goes directly to charity initiatives including food banks, homeless shelters, and our future projects like building schools and hospitals.", info2: "<strong>Donor Recognition:</strong> Your name will be proudly added to our donors list within 48 hours (unless you prefer to remain anonymous).", info3: "<strong>Privacy:</strong> If you wish to remain anonymous or use a different name, please send us a message on Instagram with your donation details and we will respect your preference." },
                ...
                contact: { title: "Order Your Games Now & Make a Difference", orderTitle: "📱 Order via Instagram", orderText: "Send us your game wishlist and help change the world, one game at a time!", paymentTitle: "💳 Secure Payment Methods", onlinePayment: "🌐 Online Payment (Reymit)", cryptoPayment: "₿ Cryptocurrency (USDT BEP20 BSC)", whyTitle: "✨ Why Choose HalfPlay Games?", whyList: '<li>✅ Save 50% on All PC Games</li><li>❤️ $5 to Charity per Purchase</li><li>✅ 100% Legal and Secure Process</li><li>✅ 3785+ Steam Games Available</li><li>✅ Instant Delivery After Payment</li><li>✅ Full Online Multiplayer Access</li><li>🌟 Help Fund Schools & Hospitals</li><li>🌍 Be Part of Something Bigger</li>' },
            ...
            ja: {
                ...
                donation: { title: "私たちのチャリティーミッションを支援", cardTitle: "💝 HalfPlay Gamesに寄付する", text: "あなたの直接の寄付は、私たちのチャリティー活動を拡大し、ゲームの力を通じてより良い世界を築く能力を増幅させます。すべての寄付の50%が私たちのチャリティーイニシアチブに直接寄付されます！", button: "Reymit経由で今すぐ寄付 💖", info1: "<strong>あなたの寄付がどのように役立つか：</strong>寄付額の半分は、フードバンク、ホームレスシェルター、そして学校や病院の建設といった将来のプロジェクトを含むチャリティーイニシアチブに直接使われます。", info2: "<strong>寄付者の表彰：</strong>あなたの名前は48時間以内に誇りを持って寄付者リストに追加されます（匿名を希望する場合を除く）。", info3: "<strong>プライバシー：</strong>匿名を希望する場合や別の名前を使用したい場合は、寄付の詳細をInstagramでメッセージしてください。私たちはあなたの希望を尊重します。" },
                ...
                contact: { title: "今すぐゲームを注文して違いを生みましょう", orderTitle: "📱 Instagram経由で注文", orderText: "ゲームのウィッシュリストを送って、一度に一つのゲームで世界を変える手助けをしてください！", paymentTitle: "💳 安全な支払い方法", onlinePayment: "🌐 オンライン決済（Reymit）", cryptoPayment: "₿ 暗号通貨（USDT BEP20 BSC）", whyTitle: "✨ なぜHalfPlay Gamesを選ぶのか？", whyList: '<li>✅ すべてのPCゲームで50%節約</li><li>❤️ 購入ごとに$5をチャリティーへ</li><li>✅ 100%合法で安全なプロセス</li><li>✅ 3785以上のSteamゲームが利用可能</li><li>✅ 支払い後即時配信</li><li>✅ 完全なオンラインマルチプレイヤーアクセス</li><li>🌟 学校や病院の資金調達を支援</li><li>🌍 より大きな何かの一部になる</li>' },
